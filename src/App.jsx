      ...
      <main className="flex-grow max-w-6xl w-full mx-auto px-6 py-12 md:py-20 flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="lg:w-1/2 space-y-6">
          ...
          <div className="pt-4">
            <button 
              onClick={scrollToForm} 
              className="px-8 py-4 bg-cyan-400 hover:bg-cyan-300 text-slate-950 font-bold rounded-lg text-sm transition shadow-lg shadow-cyan-400/20"
            >
              Get Free Quote
            </button>
          </div>
